...
ISOBoxerRTV.parseBuffer = function(arrayBuffer) {
  return new ISOFile(arrayBuffer).parse();
};

ISOBoxerRTV.Utils = {};
ISOBoxerRTV.Utils.dataViewToString = function(dataView, encoding) {
...
if (typeof exports !== 'undefined') {
  exports.parseBuffer = ISOBoxerRTV.parseBuffer;
  exports.Utils       = ISOBoxerRTV.Utils;
}
;
ISOBoxerRTV.Cursor = function(initialOffset) {
  this.offset = (typeof initialOffset == 'undefined' ? 0 : initialOffset);
}
;
var ISOFile = function(arrayBuffer) {
  this._raw = new DataView(arrayBuffer);
  this._cursor = new ISOBoxerRTV.Cursor();
  this.boxes = [];
}
...
ISOBox.prototype._parseFullBox = function() {
  ...
  //console.log("version - ",this.version, " this - ",this);
